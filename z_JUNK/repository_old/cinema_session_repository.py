...
from z_JUNK.repository_old.movie_repository import MovieRepository
from z_JUNK.repository_old.hall_repository import HallRepository
from z_JUNK.entity.cinema_session import CinemaSession
